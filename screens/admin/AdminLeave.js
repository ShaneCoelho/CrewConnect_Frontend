...
const AdminLeave = ({navigation,navigation:{goBack},route}) => {
  ...
  const fetchLeaveSummary = async () => {
    try {
      const response = await fetch('https://crewconnect.onrender.com/empleavesummary', {
        method: 'POST',
        headers: {
  ...
  const handleApproveLeave = () => {
    ...
    fetch("https://crewconnect.onrender.com/approveleave",{
        method:"POST",
        headers:{
          'Content-Type':'application/json'
        },
  ...
  const handleRejectLeave = () => {
    ...
    fetch("https://crewconnect.onrender.com/rejectleave",{
        method:"POST",
        headers:{
          'Content-Type':'application/json'
        },
